    ...
    if (variant.available) {
      $addToCart.removeClass('disabled').prop('disabled', false);
        ...
        $addToCartText.html('Add to Cart');
          ...
          $addToCartTextPopup.html('Add to Cart');
...
//     });
    ...
    document.getElementById("estimateTimer").innerHTML =hours + ":"
    + minutes + "";
    ...
    jQuery.each(cart, function(key, value) {
      if (key === 'items') {
        ...
        if (value.length) {
          ...
          $html += '<img src="//cdn.shopify.com/s/files/1/2263/8973/t/12/assets/checkout-button-icon.png?14783127072881542940" alt="" class="addIcon" />';
          $html += '<span id="CheckoutText">Secure Checkout</span>';
          $html += '</a>';
          
          $html += '<div class="cart--promo-msg">Free shipping when you spent over $99</div>';
